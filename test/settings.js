module.exports = {
    ...
    groups: [
      {
        ...
        members: ["VPN Users", "Web Users"]
      },
      {
        dn: "CN=Authors,OU=Domain Groups,DC=domain,DC=com",
        cn: "Authors",
        // The list of groups (commonName) that this group is a member of.
        members: ["Editors", "Contributors", "Web Editors", "Web Users"]
      }
    ]
  },
    ...
    users: [
      {
        ...
        members: ["My Users", "VPN Users", "Authors"]
      },
      {
      ...
      },
      {
        ...
        // The list of groups (commonName) that this user is a member of.
        members: ["My Users", "Web Administrator", "Domain Admins"]
      }
    ]
  },
  // Test settings for getGroupMembershipForGroup
  getUsersForGroup: {
    groups: [
      ...
      },
      {
        ...
        cn: "Budget Users",
        // The list of users (dn) that are members of this group.
        users: ["CN=First Last Name #1,OU=Domain Users,DC=domain,DC=com"]
      }
    ]
  },
  ...
  findGroup: {
    ...
    groups: ["Another Group", "Yet Another Group", "Authors"],
    opts: {
  ...
  findUsers: {
    users: [
      {
        query: "CN=Smith*",
        results: ["John Smith", "Bob Smith"]
      },
      {
        // A custom query that includes groups, should only return users results.
        query: "CN=*Director",
        results: ["Budget Director", "Accounts Receivable Director"]
      },
      {
  ...
  findGroups: {
    groups: [
      {
        query: "CN=My Group*",
        results: ["My Group", "My Group #1", "My Group #2"]
      },
      {
    ...
    queries: [
      {
        query: "CN=Parking*",
        results: {
          users: ["Parking Attendant #1", "Parking Attendant #2"],
          groups: ["Parking Department", "Parking Users"],
          other: ["parking-computer-01", "parking-computer-02"]
        }
      },
      {
        query: {
        ...
        results: {
          users: [],
          groups: ["Security Users", "Security Owners"],
          other: ["security-test-01", "security-test-02", "security-audit-01"]
        }
      }
    ]
  }
